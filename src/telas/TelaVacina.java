    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            try {
                ...
                // Aplicação
                String aplicacaoTexto = txtAplicacao.getText();
                java.time.LocalDate dataAplicacao = java.time.LocalDate.parse(aplicacaoTexto, formatter);
                vacina.setVacinaAplicacao(dataAplicacao);

                // Validade
                String validadeTexto = txtValidade.getText();
                java.time.LocalDate dataValidade = java.time.LocalDate.parse(validadeTexto, formatter);
                vacina.setVacinaValidade(dataValidade);
            ...
            // Animal
            int indexAnimal = cmbPet.getSelectedIndex();
            ...
            JOptionPane.showMessageDialog(null, "Vacina salvo com sucesso!");
