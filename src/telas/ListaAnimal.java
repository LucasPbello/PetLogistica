...
public class ListaAnimal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblAnimal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Raça", "Peso", "Cor", "Data de Nascimento", "Microchip", "Tamanho", "Caixa transporte", "Cliente"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Object.class
            };
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        try {
            ...
            for (Animal a : lista) {
                ...
                String nomeAnimal = a.getNome().toLowerCase();
        ...
        try {
            ...
            for (Animal a : lista) {
                modelo.addRow(new Object[]{
                    ...
                    a.getTamanho(),
                    a.getCaixaTransporte(),
                    a.getCliente() != null ? a.getCliente().getNome() : "Sem animal"
                });
            }
